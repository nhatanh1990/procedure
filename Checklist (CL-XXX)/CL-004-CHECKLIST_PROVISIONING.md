...
- [ ] Thời gian cần đã được xác định

### 1.2. Phê duyệt

- [ ] Yêu cầu đã được đánh giá
- [ ] Tài nguyên đã được kiểm tra
- [ ] Yêu cầu đã được phê duyệt
- [ ] Tài nguyên đã được phân bổ

---

## 2. CHECKLIST THIẾT KẾ
...
- [ ] Network đã được thiết kế

### 2.2. Review

- [ ] Thiết kế đã được review bởi Infrastructure Team
- [ ] Thiết kế đã được review bởi Security Team (nếu cần)
- [ ] Thiết kế đã được review bởi Development Team
- [ ] Thiết kế đã được phê duyệt

---

## 3. CHECKLIST CUNG CẤP

### 3.1. Tạo tài nguyên

- [ ] Server đã được tạo
- [ ] Database đã được tạo (nếu cần)
- [ ] Network đã được cấu hình
- [ ] Storage đã được cấu hình (nếu cần)

### 3.2. Cấu hình hệ thống

- [ ] OS đã được cấu hình
- [ ] System parameters đã được cấu hình
...
- [ ] Application configuration đã được cấu hình
- [ ] Environment variables đã được cấu hình
- [ ] Feature flags đã được cấu hình (nếu cần)

### 4.2. Cấu hình database

- [ ] Database configuration đã được cấu hình
- [ ] Connection pool đã được cấu hình
- [ ] Backup đã được cấu hình

### 4.3. Cấu hình monitoring

- [ ] Monitoring đã được cấu hình
- [ ] Alerting đã được cấu hình
- [ ] Dashboard đã được tạo

### 4.4. Cấu hình backup

- [ ] Backup schedule đã được cấu hình
- [ ] Backup retention đã được cấu hình
- [ ] Test restore đã được lên kế hoạch
...
- [ ] SSH/RDP đã được test
- [ ] Network connectivity đã được test
...
- [ ] Throughput đạt yêu cầu
- [ ] Resource usage trong giới hạn

### 5.4. Test bảo mật

- [ ] Firewall rules đã được test
- [ ] Access control đã được test
- [ ] Encryption đã được test
- [ ] Vulnerability scan đã pass
...
- [ ] Thông tin kết nối đã được ghi nhận
- [ ] Credentials đã được lưu trong secret management
- [ ] Runbook đã được tạo
