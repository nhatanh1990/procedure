...
## Cấu hình Metadata cho Hệ thống Quy trình
...
- **Email quản lý**: [manager@company.com]

### Thông tin người phụ trách

- **Người soạn chính**: [Tên]
- **Người phê duyệt**: [Tên]
...
- **Format chuẩn**: YYYY-MM-DD (ví dụ: 2024-12-17)
...
- **Ngày ban hành**: 2024-12-17
- **Trạng thái**: Chính thức
- **Phiên bản**: 1.0 (hoặc 2.0 cho TP-003)
...
1. Khi có thay đổi metadata, cập nhật file này
2. Cập nhật version và ngày cập nhật
3. Thông báo các team liên quan
...
- Khi có thay đổi, cần cập nhật file này trước
